...
FLAGS="--sysconfdir=/etc --localstatedir=/var --enable-tests --enable-compat-howl --enable-compat-libdns_sd --disable-dbus --disable-gtk3 --disable-gtk --disable-static --disable-mono --disable-monodoc --disable-python --disable-qt3 --disable-qt4"
